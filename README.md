...
出行时，想顺路买一杯饮料？出差时，想在换乘过程中最快速打卡自己想吃的店铺？

顺路导航功能上线：给定起点、终点和想要打卡的地点，系统会根据算法自动筛选出最顺路的路线方案，并通过可视化交互呈现，支持步行、公共交通、驾车等多种交通方式。

**用户输入**

> 我现在要从上海虹桥出发，到浦东机场，请问路途去哪些 grid 咖啡门店最方便

**系统响应**

Blanket 识别到用户在导航需求中附加了顺路打卡点，自动在起点与终点之间筛选出偏离成本最低的商户，并生成可交互的路线方案卡片：

![顺路商户推荐](docs/images/顺路.jpg)

![路线方案](docs/images/规划3.jpg)
...
![火车票查询](docs/images/火车票1.jpg)

点击卡片可以查看坐席价格、剩余票数，也可以手动进行高级筛选。
...
1. **自动调研目的地**：输入目的地后，Blanket 自动检索当地热门景点、特色美食与实用攻略。
2. **景点与美食推荐**：结合实时信息与用户评价，生成结构化的景点和美食清单。
3. **行程自动规划**：根据兴趣偏好与时间安排，智能串联景点与餐厅，输出可执行的出游路线。

![旅游规划](docs/images/旅游.jpg)
