...
### _RAW 素材层：像人一样保留对话现场_

每次对话的原始消息都会被保留下来，就像人脑中的短期工作记忆。在上下文窗口允许时，模型可以直接读取这些原消息，而不是只能看到被压缩后的摘要。这让 Agent 能够捕捉到语气、犹豫、临时修改等细腻信息。
...
这样，即使对话很长，Agent 也不会突然「失忆」，而是像人一样保留近期细节、压缩远期细节。
